...
Values are reported as train-time / deploy-time, i.e. before and after local-branch
re-parameterization.
...
The deploy-time parameter count (4.744 M) is the one used for the main quantitative
table and matches the released inference checkpoints.
